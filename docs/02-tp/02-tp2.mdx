    ...
    <TabItem value="velos" label="📌 Projet vélos 🚲" default>
        ...
        <Row>
            <Column>
                ...
                💡 Astuces :
                - [Créer une nouvelle colonne](/cours/rencontre11?onglet=pandas#-cr%C3%A9er-de-nouvelles-colonnes) représentant l'heure sans les minutes et secondes.
            ...
            <Column>
                ...
                💡 Astuces :
                - Créer un dictionnaire ayant comme clé le no du mois et comme valeur son nom
                - Utiliser la méthode map pour créer une nouvelle colonne pour le nom du mois
                :::
            </Column>
        </Row>
        <Row>
            <Column>
                ...
                💡 Astuces :
                - Utiliser un tableau croisé dynamique (pivot table)
                :::
            </Column>
            <Column>
                :::info Figure 4
                ...
                💡 Astuces :
                - Regrouper les données par compteur, puis calculez la moyenne
                - La taille des points est le nombre moyen de passage x 10
