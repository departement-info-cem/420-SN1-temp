...
<Row>
    ...
    <Column>
        ...
        Pour **chacune des deux méthodes**, vous devez créer une fonction prenant un nombre en paramètre et retournant
        la racine carrée de ce nombre en utilisant cette méthode. La précision doit être de 4 décimales.
...
<Row>
    <Column>
        ...
        Vous allez comparer vos méthodes avec `math.sqrt` sur 10 000 nombres pseudo-aléatoires. Pour y parvenir, vous devez :

        1. À l'aide d'une boucle, générez  **100 000 nombres flottants** aléatoires entre 10 et 1000.
        ...
        3. Afficher :
        - Le **temps total (en nanosecondes)** pour chaque méthode
