...
<Row>
    ...
    <Column>
        :::info <Highlight color="tip"><span style={{color: 'white'}}>1 point</span></Highlight> Documentation des fonctions
...
<Row>
    ...
    <Column>
        ...
        - Si 0 < n < 1 : intervalle initial = [0, 1]

        À chaque étape :
        - On calcule le milieu = (bas + haut) / 2
        - Si milieu² est trop petit, on déplace bas = milieu
        - Si milieu² est trop grand, on déplace haut = milieu

        On continue jusqu'à ce que la largeur de l’intervalle (haut - bas) soit inférieure à la précision souhaitée.
...
::::
:::note <Highlight color="tip"><span style={{color: 'white'}}>3 points</span></Highlight> 📈 Comparaison des performances
