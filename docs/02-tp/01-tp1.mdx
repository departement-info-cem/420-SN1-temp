...
:::warning <Highlight color="tip"><span style={{color: 'white'}}>2 points</span></Highlight> Répertoire Git
    Un minimum de 5 commits de tailles comparables.\
    Il n'y a pas un commit avec tout dedans et les autres vides.\
    Au moins un commit par semaine.\
...
<Row>
    ...
    <Column>
        ...
        Pour **chacune des deux méthodes**, vous devez créer une fonction qui prendra un nombre en paramètre et renverra la racine
