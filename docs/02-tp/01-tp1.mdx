...
<Row>
    <Column>
        ...
        - Valider le bon fonctionnement de vos algorithmes à l'aide de jeux d'essais
        :::
    </Column>
    <Column>
        :::info 🧠 Contexte
...
<Row>
    ...
    <Column>
        ...
        On continue ainsi jusqu'à la précision désirée. Comment savoir qu'on a atteint la précision désirée?  \
        Il faut regarder la différence entre les 2 intervalles (haut et bas), si elle est inférieure à la précision souhaitée, 
        on peut alors considérer qu'on a suffisamment réduit l'intervalle pour atteindre la précision souhaitée et qu'il n'est pas nécessaire de continuer davantage.
        ...
        \
            Début : [0, 8] -> 8 - 0 = 8 ... c'est plus grand que 0.001 on continue ... \
                    nouvel intervalle [0, 4] -> 4 - 0 = 4 ... c'est plus grand que 0.001 on continue \
                    nouvel intervalle [2, 4] -> 4 - 2 = 2 ... c'est plus grand que 0.001 on continue \
                    ... \
                    nouvel intervalle [2.828125, 2.8291015625] → 2.8291015625 - 2.828125 = 0.0009765625 on est en bas de 0.001 on peut arrêter!
                    
                    la réponse serait la moyenne de 2.828125 et 2.8291015625 qu'on arrondie à 2 décimales
...
<Row>
    <Column>
        ...
        1. À l'aide d'une boucle, générez  **10 000 nombres flottants** aléatoires entre 10 et 1000.
    ...
    <Column>
        ...
        racine n-ième d'un nombre, vous devez rajouter un paramètre `base` (ex. : 2 pour racine carrée, 3 pour racine cubique, etc.).
