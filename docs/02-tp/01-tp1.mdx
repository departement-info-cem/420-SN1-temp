...
- Votre projet doit contenir exactement 3 fichiers script Python et rien d'autre :
```
tp1/
...
Dans le script `racine.py`, vous devez créer 2 fonctions pour représenter les méthodes pour calculer la racine carrée d'un nombre.\
...
Mettez la précision de votre choix dans une variable à l'intérieur de vos 2 fonctions <i>(comme une constante, ex : PRECISION = 8)</i>.
