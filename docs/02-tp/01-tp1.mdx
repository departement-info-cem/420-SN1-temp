...
<Row>
    ...
    <Column>
        ...
        La précision doit être entre 4 et 14 décimales à votre discrétion. Supérieur à 14 décimales, le calcul prend trop de temps et le programme arrête de fonctionner.
