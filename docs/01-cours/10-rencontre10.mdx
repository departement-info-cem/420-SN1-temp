...
<Tabs queryString="onglet">
    ...
    <TabItem value="csv" label="Fichier CSV">
        ...
        Des conversions peuvent être nécessaires au besoin. Dans l'exemple précédent, la fonction `float` a été appelée lors de la lecture des nombres.
    ...
    <TabItem value="numpy" label="Numpy">
        ...
        NumPy permet de filtrer les éléments d’un tableau rapidement selon des conditions logiques, sans devoir utiliser de boucles for! \
        La syntaxe est la suivante : <i>**tableau[tableau operateur_de_comparaison expression]**</i> \
        ...
        **Combiner plusieurs conditions** \
        On peut combiner plusieurs conditions logiques l'ensemble. \
        L'exemple ci-dessous applique 2 conditions à l'aide d'un <i>ET</i> logique.
        ...
        :::info Opérateurs arithmétiques, utile pour vos graphiques!

        Les tableaux NumPy permettent d’utiliser directement les opérateurs arithmétiques +, -, *, /, **, etc. \
        Ces opérations s’appliquent **élément par élément** et **génère un nouveau tableau** sans besoin de boucle for!
        ...
        Ceci est particulièrement utile pour générer une liste de y pour alimenter vos graphiques avec MatPlotLib!
    ...
    <TabItem value="matplotlib" label="Numpy et Matplotlib">
        ...
        x = np.linspace(0, 10, 100)   #Créer un tableau NumPy de 100 points entre 0 et 10
        y = np.sin(x)                 #Fonction sinus retournant un tableau NumPy
        ...
        #### Exemple #2 - Représenter une fonction personnalisée graphiquement!

        Imaginons que nous avons une formule personnalisée qu'on souhaite représenté graphiquement : y = 2 x a - 15 \
        Grâce aux pouvoirs des opérateurs arithmétiques sur des tableaux NumPy, on peut créer un tableau NumPy y des résultats rapidement!
        ...
        y = 2 * x - 15                   #Générer un tableau NumPy des y grace aux pouvoirs des opérateurs arithmétiques sur le tableau NumPy x

        # Tracer le graphique
        plt.plot(x, y)
        plt.title("Graphique de la fonction linéaire : y = 2 x a - 15")
        plt.xlabel("x")
        plt.ylabel("y")
        plt.grid()
        plt.show()
