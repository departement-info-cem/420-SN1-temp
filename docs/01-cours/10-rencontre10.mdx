...
<Tabs queryString="onglet">
    ...
    <TabItem value="exercices" label="Exercices">
        ...
        Tu dois analyser les populations de différentes espèces animales dans une réserve naturelle. \
        ...
        Calcul et affiche à la console le résultat ci-dessous. \
        ...
        Générer le graphique ci-dessous en utilisant les données de la variable population.
        ...
        ```
        Écrire un programme présentant ces informations sous la forme suivant :
        ```python
