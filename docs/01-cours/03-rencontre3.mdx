...
<Tabs queryString="onglet">
    ...
    <TabItem value="exercices" label="Exercices">
        ...
        **Beaucoup d'instructions** servant a afficher des données **sont très similaires** et sont utilisées dans le **même ordre**. \
        ...
        def calcul_intensif():
            '''
            N'essaie VRAIMENT pas de comprendre le code de cette fonction!
            Tu vas être capable de le comprendre à partir du cours sur les boucles.
            La seule chose qui est importante de savoir, c'est ce cette fonction prends un
