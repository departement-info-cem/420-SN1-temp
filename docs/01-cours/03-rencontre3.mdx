...
<Tabs queryString="onglet">
    ...
    <TabItem value="portee" label="Portée">
        ...
        Elle peut être utilisée dans tout le programme, y compris à l’intérieur des fonctions (sauf si une variable du même nom est redéfinie localement).
        ...
        :::warning Une variable à le même nom globalement et localement!

        Si une variable a le même nom dans le programme et dans une fonction, \
        la version locale prend le dessus dans la fonction. Elle cache la variable globale, mais ne la modifie pas.
