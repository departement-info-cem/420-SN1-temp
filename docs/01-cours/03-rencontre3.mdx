...
<Tabs queryString="onglet">
    ...
    <TabItem value="exercices" label="Exercices">
        ...
        **Beaucoup d'instructions** servant a afficher des données **sont très similaires** et sont utilisées dans le **même ordre**. \
        ...
        En lisant la documentation du module time  ([doc](https://docs.python.org/fr/3.13/library/time.html)), trouvez une fonction :
        1. ne nécessitant aucun argument,
        2. retournant un `int` qui représente le temps présent en nanosecondes.

        Puis, créez votre propre fonction nommée <i>temps_en_ns()</i> sans paramètre. 🔨 \
        Votre fonction doit simplement retourner la valeur renvoyée par la fonction que vous avez trouvée.
        
        Ensuite, ajoutez le code suivant à votre script et exécutez-le :
        ...
        **Question** \
        ✏️ Selon vous, en observant les instructions 12 à 16, que représente le nombre contenu dans la variable <i>mystere</i>?
