...
<Tabs queryString="onglet">
    ...
    <TabItem value="exercices" label="Exercices">
        ...
        *Objectif :* pratiquer la décomposition d’un problème en plusieurs fonctions réutilisables.
        ...
        :::info Exercice - Refactorisation du code - Affichage des résultats expérimentations

        Le code ci-dessous permet d'afficher les résultats de différentes expérimentations scientifiques. \
        Beaucoup d'instructions sont redondantes ou très similaires avec juste des différences mineures. \
        ...
        ```python
        print("Rapport - Résultats des expériences")

        print("Échantillon : Solution A")
        print("Température : 22.5°C")
        print("pH : 6.8")
        print("Concentration : 0.15 mol/L")
        print("---------------")

        print("Échantillon : Solution B")
        print("Température : 25.0°C")
        print("pH : 7.2")
        print("Concentration : 0.10 mol/L")
        print("---------------")

        print("Échantillon : Solution C")
        print("Température : 20.0°C")
        print("pH : 5.5")
        print("Concentration : 0.20 mol/L")
        print("---------------")

        print("Merci de votre lecture")
        ```
