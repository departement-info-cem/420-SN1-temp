...
<Tabs queryString="onglet">
    ...
    <TabItem value="simple" label="Fonction simple" default>
        ...
        *Appeler* une fonction se fait en écrivant son nom suivi de parenthèses.<br />
        ...
        La définition d'une fonction doit toujours être placée avant les appels à ces dernières. \
        Tentez d'appeler une fonction avant la définition génère une erreur similaire à ceci :
        \
        \
    ...
    <TabItem value="pile" label="Pile d'appels">
        ...
        Lorsque vous faite une trace d'un code avec des appels de fonctions, \
    ...
    <TabItem value="comments" label="Commentaires">
        ...
        Ce type de documentation est nommée un **docstring** et est toujours placé au début de la définition d'une fonction. \
        ...
        Elles sont ignorées par Python lors de l'exécution du code.<br /><br />
    ...
    <TabItem value="exercices" label="Exercices">
        ...
        *Objectif :* pratiquer la décomposition d’un problème en plusieurs fonctions réutilisables.
        ...
        Le code ci-dessous afficher un rapport concernant des expérimentations réalisées par une entreprise pharmaceutique de confiance. \
        **Beaucoup d'instructions** servant a afficher des données **sont très similaires** et sont utiliser dans le **même ordre**. \
        En programmation, c'est un **signe** qu'on doit **créer une fonction**! \
        \
        Améliorez ce code! Définissez une fonction réutilisable et utilisez-la.
        ...
        Le code ci-dessous permet de calculer la densité en kg/m<sup>3</sup> de 3 échantillons pour lesquelle nous possédons une masse en g et un volue en cm<sup>3</sup>. \
        Le calcul de la densité nécessite plusieurs instructions. **Simplifiez ce code en créant une fonction réutilisable** pour calculer la densité en kg/m<sup>3</sup> et utilise-la.

        ⚠️Il est **INTERDIT de modifier** les instructions **1 à 7** et **20 à 23** inclusiement.
        ...
        En lisant la documentation du module time  ([doc](https://docs.python.org/fr/3.13/library/time.html)), trouver une fonction : 
        - Ne nécessitant aucun argument
        - Retournant un int représentant un temps en nanosecondes

        Ensuite, créer votre propre fonction nommée <i>temps_en_ns()</i> sans paramètre. 🔨 \
        Votre fonction doit simplement retourner la valeur renvoyée par la fonction que vous avez trouvé.
        ...
        def calcul_intensif():
            '''
            Fonction dont le code n'est pas important, mais prenant un certain temps à s'exécuter
            '''
            total = 0
            for i in range(1, 20_000_000):  # 20 million d'itérations
                total += i ** 0.5
            return total
        ...
        **Question** \
        ✏️ Selon vous, en observant les instructions 12 à 16 que représente le nombre retourné par la variable <i>mystere</i>? 
        
        **Instructions pour vous aider dans votre réflexion**
        - Exécutez le programme tel quel et notez la valeur affichée,
        - À la ligne 6, modifiez le nombre 20_000_000 en 40_000_000,
    ...
    <TabItem value="recusivite" label="*Récursivité*">
        ...
        La récursivité est un concept plus avancé qui dépasse le cadre de ce cours.<br/> 
        Il n'est pas obligatoire pour réussir le cours, mais qui peut être intéressant à explorer si vous êtes curieu.x.se.<br />
