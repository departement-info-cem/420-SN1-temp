...
<Tabs queryString="onglet">
    ...
    <TabItem value="parametres" label="Paramètres">
        ...
        Lorsqu'une fonction est appelée, les valeurs transmises (les arguments) fournis sont associées aux paramètres définis dans la fonction.
        ...
        Si aucune valeur n'est fourni pour un paramètre lors de l'appel de la fonction, la valeur par défaut sera utilisée.
        ```python showLineNumbers
        ...
        saluer("Alice")  # Affiche "Bonjour, Alice!"
        ```
        Dans cet exemple, si `saluer` est appelée sans valeur, `nom` prendra la valeur par défaut "inconnu". \
        \
