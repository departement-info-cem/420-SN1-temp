...
Voici comment Python évalue l’instruction #5, étape par étape :
    ...
    <TabItem value="else" label="else">
        ...
        Cet exemple permet de calculer le salaire d'un employé
        ...
        print(f"  Avec le temps > 40 payé au taux régulier : {calculer_paie_brute(nb_heures, taux_horaire, False)}$")
        ```
        :::
    ...
    <TabItem value="exceptions" label="Exceptions">
        ...
        Exemple minimal :
        ```python showLineNumbers
        class DonneesInvalidesError(Exception):
            pass
