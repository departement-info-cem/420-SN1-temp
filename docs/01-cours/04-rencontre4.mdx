...
Voici comment Python évalue l’instruction #5, étape par étape :
    ...
    <TabItem value="exercices" label="Exercices">
        ...
        Si aucun solution (ex : a = 1, b = 2, c = 5)
        ```python
        Il n'y a pas de solution possible pour ces valeurs de a, b et c
        ```

        Si une seule solution (ex. a = 1, b = 6, c = 9)
        ```python
        Il y a une seule solution possible : -3
        ```

        Si 2 solutions possibles pour ce problème (ex. a = 1, b = 5, c = 6)
        ```python
        Il y a 2 solutions possibles pour ce problème sont : -2 et -3
        ```
        :::
