...
<Tabs queryString="onglet">
    ...
    <TabItem value="expressions" label="Expressions booléennes" default>
        ...
        | Opérateur | Description                   | Exemple                  | Résultat          |
        |-----------|-------------------------------|--------------------------|-------------------|
        | `in`      | Appartenance (contenu dans)   | `"a" in "chat"`         | `True` si `"a"` est dans `"chat"`, sinon `False` |
        | `not in`  | Non-appartenance (pas dans)   | `"b" not in "chat"`     | `True` si `"b"` n'est pas dans `"chat"`, sinon `False` |
        :::
    ...
    <TabItem value="if" label="if">
        ...
        C'est bien beau les expressions booléennes, mais à quoi ça sert?<br />
