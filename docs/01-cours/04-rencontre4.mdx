...
Voici comment Python évalue l’instruction #5, étape par étape :
    ...
    <TabItem value="exercices" label="Exercices">
        ...
        Complétez ce programme afin qu'il trouve les solutions pour n'importe quelles valeurs de $a$, $b$ et $c$ :
        ...
        1. Créez une fonction :
            - qui prend en entrées les 4 nombres représentant les notes,
