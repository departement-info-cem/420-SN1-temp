...
Voici comment Python évalue l’instruction #5, étape par étape :
    ...
    <TabItem value="exceptions" label="Exceptions">
        ...
        :::note Intercepter une erreur personnalisée (`try/catch`)
        ...
        try:
            ...
            concentration(4,20)         #OKI, éxécutée sans problème
        ...
        ```
        La variable `e` représente ici l'exception intercepté, tenter de l'afficher à la console va afficher le message d'erreur personnalisé.
    ...
    <TabItem value="validation" label="Validation">
        ...
        **Version 1 – sans validation**
        ...
        ```
        Ici, la fonction ne réalise pas de validation, le programme plante si on entre un volume nul ou une masse invalide avec des **messages d'erreur générique**.
        ...
        **Version 2 – avec validation**
        ...
        ```
        Ici, la fonction réalise des validations et lève des exceptions dans plus de situation accompagné de **messages d'erreur clair et précis**. 
        :::
    ...
    <TabItem value="exercices" label="Exercices">
        ...
        Pensez à tester votre code avec des cas sans solution, avec une seule solution et avec 2 solutions distinctes.
        ...
        Pour cette exercice, vous devez remplacer les `if/elsif/else` du code ci-dessous par un `match`.
