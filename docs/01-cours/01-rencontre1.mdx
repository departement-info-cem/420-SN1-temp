...
<Tabs queryString="onglet">
    ...
    <TabItem value="exercices" label="Exercices">
        ...
        En suivante [cette recette](/recettes/creer-repo-github), créez-vous un répertoire GitHub pour y déposer vos
        exercices.
        ...
        En suivante [cette recette](/recettes/creer-projet), créez un projet PyCharm dans votre répertoire GitHub cloné
        sur le bureau de votre poste.
