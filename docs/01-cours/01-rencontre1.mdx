...
[👉 Télécharger le notebook](/ressources/notebooks/01-1_bioinfo_analyse_sequences_ARN.ipynb)
:::
...
[👉 Télécharger le notebook](/ressources/notebooks/01-2_generation_fractales.ipynb)
:::
...
[👉 Télécharger le notebook](/ressources/notebooks/01-3_reconnaissance_chiffres.ipynb)
:::
