...
<Tabs queryString="onglet">
    ...
    <TabItem value="exercices" label="Exercices">
        ...
        Pour les exercices suivants, vous pouvez écrire vos réponses sur papier (comme ce sera le cas en examen) ou dans un [fichier markdown](/recettes/creer-markdown) dans votre projet PyCharm créé plus haut.
