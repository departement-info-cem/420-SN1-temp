...
<Tabs queryString="onglet">
    ...
    <TabItem value="exercices" label="Exercices">
        ...
        :::info Exercice - AFFICHAGE AMÉLIORÉE DES VIRUS
        ...
        ##### 🧩 CAS À COMPLÉTER
        1. Union des deux ensembles \
           <i>Résultat attendu : \{1, 2, 3, 4, 5, 6, 7, 8}</i>

        2. Intersection des deux ensembles \
           <i>Résultat attendu : \{4, 5}</i>

        3. Différence entre ensemble1 et ensemble2 \
           <i>Résultat attendu : \{1, 2, 3}</i>
