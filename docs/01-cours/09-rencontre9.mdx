...
<Tabs queryString="onglet">
    ...
    <TabItem value="exercices" label="Exercices">
        ...
        **N'exécutez pas le code avant d'avoir terminé votre dessin !**
        ...
        - Vous **n'avez pas** le droit d'utiliser des fonctions prédéfinies comme `min()`, `max()`, `sum()` et `len()` **(ಥ⌣ಥ)**.
        ...
        l'ordre des éléments peut varier (en particulière si vous avez utilisé un set)!
