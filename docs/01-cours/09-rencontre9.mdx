...
<Tabs queryString="onglet">
    ...
    <TabItem value="exercices" label="Exercices">
        ...
        Différentes mesures de la température ont été prise durant la journée :
        ...
        - Calculer par programmation :
            - La température la plus petite
            - La température la plus élevé
            - La température moyenne
            - Le nombre de mesure prise
        - Afficher ces informations dans le format défini plus bas

        ##### ⚠️ CONTRAINTES À RESPECTER

        - Vous **n'avez pas** le droit d'appeller des fonctions :(
        ...
        Recopier le code du numéro précédent dans un nouveau script python. \
        Vous devez cette version du code afin de respecter ces 2 contraintes :
        - Vous **n'avez pas** le droit d'utiliser de boucle
        - Vous devez utilisez des fonctions pour vos calculs (ex : min)

        :::

        :::info Exercice - Jeu de devinette passif-aggressif

        Vous devez modifier le code du jeu de devinette de nombre de la rencontre 3. \
        Dans cette version, si l'utilisateur saisie un nombre déjà saisie précédemment, vous devez l'insulter. \
