...
<Tabs queryString="onglet">
    ...
    <TabItem value="set" label="Ensemble (set)">
        ...
        - **Modifiable** : Vous pouvez ajouter ou supprimer des éléments d'un ensemble après sa création.
        :::
        ...
        - **Union** : Utilisez l'opérateur `|` ou la méthode `union()` pour obtenir l'union de deux ensembles.
        ```python showLineNumbers
        union = mon_ensemble | autre_ensemble
        ```
        - **Intersection** : Utilisez l'opérateur `&` ou la méthode `intersection()` pour obtenir l'intersection de deux ensembles.
        ```python showLineNumbers
        intersection = mon_ensemble & autre_ensemble
        ```
        - **Différence** : Utilisez l'opérateur `-` ou la méthode `difference()` pour obtenir la différence entre deux ensembles.
        ```python showLineNumbers
        difference = mon_ensemble - autre_ensemble
        ```
        - **Différence symétrique** : Utilisez l'opérateur `^` ou la méthode `symmetric_difference()` pour obtenir les éléments qui sont dans l'un ou l'autre des ensembles, mais pas dans les deux.
        ```python showLineNumbers
        sym_diff = mon_ensemble ^ autre_ensemble
        ```
        :::
