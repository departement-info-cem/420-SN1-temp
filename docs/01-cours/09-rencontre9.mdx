...
<Tabs queryString="onglet">
    ...
    <TabItem value="exercices" label="Exercices">
        ...
        Le code ci-dessous tri une liste en utilisant un algorithme nommé le tri à bulles. \
        Réaliser la trace d'exécution de ce code.
        ...
        - Vous **n'avez pas** le droit d'utiliser des fonctions **(ಥ⌣ಥ)**.
        - Vous pouvez utiliser qu'**une seule boucle**.
        - Votre code doit fonctionner peu importe le nombre de mesure prise.
        ...
        Recopier le code du numéro précédent dans un nouveau script, il vous servira de point de départ. \
        Vous devez modifier le code afin de respecter ces 2 contraintes :
        - Vous **n'avez pas** le droit d'utiliser de boucle.
        - Vous devez utiliser des fonctions pour réaliser les calculs.
        ...
        Recopier le code de l'exercice "**Jeu de devinette**" de la rencontre #5, il vous servira de **point de départ**. \
        ...
        :::info Exercice - AFFICHAGE AMÉLIORÉE DES VIRUS - VERSION 1 (2 LISTES SÉPARÉES)

        Recopier le code du 1<sup>er</sup> numéro dans un nouveau script, il vous servira de point de départ.

        La Umbrella Corporation souhaite améliorer le rapport précédent fait. \
        Elle vous fournie sous la forme d'une liste des caractéristiques sur chaque virus.
        ...
        <i>**Remarques** : Les 2 listes ont toujours le même nombre d'éléments et l'ordre est cohérente.</i>
        ...
        La Umbrella Corporation souhaite améliorer le rapport précédent fait. \
        La corporation souhaite désormait affiché dans le rapport le taux de succès de mutation. \
        Elle vous fournie désormait toutes les données sous la forme d'une seule liste!
        ...
        :::info Exercice - Manipulation de listes de compréhensions

        Les listes en compréhension permet de transformer, filtrer et manipuler des données de manière concise et efficace. \
        ...
        Tu dois créer **10 nouvelles listes** en utilisant **exclusivement des compréhensions de liste**. \
        ...
        Pour chaque cas, tu dois écrire ton code comme ceci :

        ```python
        casX = [ ... ]  # Remplace les "..." par ta compréhension de liste
        print(casX)
        ```
        ...
        Tu dois créer **3 nouveaux ensembles** en utilisant **exclusivement des opérations sur les set**. \
        ...
        ```python
        casX = [ ... ]  # Remplace les "..." par ton opération sur les ensembles
        print(casX)
        ```
        ...
        Vous devez reproduire le graphique suivant :
        ...
        :::info Exercice - Graphique 2
         ...
         Vous devez reproduire le graphique ci-dessous. \
