...
<Tabs queryString="onglet">
    ...
    <TabItem value="pandas" label="🐼 Pandas">
        ...
        Le <a href={useBaseUrl('/ressources/csv/tips_dataset.csv')} download="tips_dataset.csv">fichier tips_dataset.csv</a> contient des données sur les pourboires donnés dans un restaurant, avec des colonnes telles que le montant total de la facture, le pourboire, le sexe du serveur, etc.
