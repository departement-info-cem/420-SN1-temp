...
<Tabs queryString="onglet">
    ...
    <TabItem value="exercices" label="Exercices">
        ...
        :::info Exercice - Écrire du code sans PyCharm - Liste

        Sur papier, sans ordinateur, écrivez le code permettant de connaitre le nombre de valeur supérieur à 50 dans une liste. \
        ...
        Le programme devrait afficher avec cette liste le résultat suivant :


        ```python
        Contenu de la liste : [20,60,50,10,70,90]
        Nombre de valeur supérieure à 50 : 3
        ```

        Votre programme doit fonctionner peut importe le nombre d'éléments de la liste.
        ...
        **Validez** votre réponse à l'aide de **Pycharm**.
        ...
        1. Charger les données dans un DataFrame.
        2. Créer des nouveaux DataFrames à partir du DataFrames de départ vous permettant d'obtenir ces informations :
            1. Les modèles japonais ayant une accélération de 19.4 et plus
            2. Le nombre ligne dans le fichier par origine du véhicule
            3. Les noms des modèles apparaissant 5 fois où plus dans le fichier
        3. Présenter les résultats de ces DataFrame exactement comme ci-dessous :
        ...
        Le nombre ligne dans le fichier par origine du véhicule :
            - europe : 70
            - japon  : 79
            - usa    : 249

        Les noms des modèles apparaissant 5 fois où plus dans le fichier :
            - fort pinto (6 fois)
            - amc matador (5 fois)
            - fort maverick (5 fois)
            - toyota corolla (5 fois)
        ```
        :::
