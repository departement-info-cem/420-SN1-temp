...
<Tabs queryString="onglet">
    ...
    <TabItem value="exercices" label="Exercices">
        ...
        Votre programme doit fonctionner peut importe le nombre d'éléments dans la liste et ses nombres.
        ...
        **Validez** votre réponse à l'aide de **Pycharm**.
        ...
        2. Créer des nouveaux DataFrames à partir du DataFrames de départ vous permettant d'obtenir ces informations :
            ...
            3. Le nombre de voiture japonnaise avec un poid supérieur à 2500
        ...
        Les 5 voitures avec le plus de horsepower :
            - pontiac grand prix - horsepower : 230.0
            - buick electra 225 custom - horsepower : 225.0
            - pontiac catalina - horsepower : 225.0
            - buick estate wagon (sw) - horsepower : 225.0
            - chevrolet impala - horsepower : 220.0

        Le nombre de voiture japonnaise avec un poid supérieur à 2500 : 17
        ```
        :::
