...
<Column>
    ![point](../../static/img/recettes/point_arret.png)
</Column>
</Row>
...
![point](../../static/img/recettes/pile_variables.png)
...
- <img src={require('/static/img/icons/resume.png').default} alt="Resume" width="24" style={{ verticalAlign: 'middle' }} /> **Resume** : continuer l’exécution jusqu’au prochain point d’arrêt rencontré.
...
![point](../../static/img/recettes/evaluate_expression.png)
