...
|--------------------------|------------------------------------------------------------|---------------|
| a = 3                    | a: 3                                                    | __main__      |
| b = 5                    | a: 3 <br /> b: 5                                               | __main__      |
| z = ma_fonction(a, b) | a: 3 <br /> b: 5 <br /> appelle ma_fonction avec a→3 et b→5       | __main__      |
| c = a + b                | a: 3 <br /> b: 5 <br /> c: 8                                        | ma_fonction <br /> main |
| return c                 | a: 3 <br /> b: 5 <br /> c: 8, retourne 8, z = 8                     | ma_fonction <br /> main |
| y = ma_fonction(4, 9) | a: 3 <br /> b: 5 <br /> z: 8 <br />appelle ma_fonction avec a→4 et b→9 | __main__      |
| c = a + b                | a: 4 <br /> b: 9 <br /> c: 13                                       | ma_fonction <br /> main |
| return c                 | a: 4 <br /> b: 9 <br /> c: 13 <br /> retourne 13, y = 13                  | ma_fonction <br /> main |
| print("z vaut " + str(z) + " et y vaut " + str(y)) | a: 4 <br /> b: 9 <br /> z: 8 <br /> y = 13 <br /> affiche "z vaut 8 et y vaut 13" | __main__     |
