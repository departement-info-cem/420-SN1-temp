...
Voici les options de formatages les plus courantes pour les f-string. \
Ces options doivent être placées immédiatement à la fin de l'expression avant l'accolade fermante.

**Exemple**
```python showLineNumbers
print(f"Le résultat de {nombre1} x {nombre2} est : {nombre1 * nombre2:2f}") #le résultat est arrondi à 2 décimales
```
